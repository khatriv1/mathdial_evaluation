# mathdial_evaluation/evaluation/evaluate_few_shot.py
...
def evaluate_few_shot(data_path: str, api_key: str, output_dir: str = "results/few_shot", limit: int = None):
    """Evaluate Few-shot prompting technique on MathDial dataset."""
...
if __name__ == "__main__":
    ...
    try:
        print("\nStarting Few-shot evaluation on MathDial dataset...")
